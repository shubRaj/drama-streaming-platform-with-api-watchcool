...
urlpatterns = [
    ...
    path("actor/<slug:slug>/",cache_page(CACHE_TIME)(views.ActorDetail.as_view()),name="actor_detail"),
    ...
    path("category/<str:category>/",cache_page(CACHE_TIME)(views.GenreView.as_view()),name="category"),
    ...
    path("",cache_page(60*30)(views.HomeView.as_view()),name="home"),
]