    ...
    $.typeahead({
        ...
        template: function(query, item) {
            return '<div class="d-flex align-items-center" data-id="{{url}}">' +
                '<div class="media mr-2" style="background-image:url({{poster_path}})"></div>' +
        ...
        click: function() {
            ...
            switch (dataType) {
                case 'facebook':
                    ...
                    break;
                case 'twitter':
                    shareWindow('https://twitter.com/intent/tweet?text=' + encodeURIComponent(dataTitle) + ' ðŸŽ¬ ' + encodeURIComponent(dataSef));
                    break;
            }
