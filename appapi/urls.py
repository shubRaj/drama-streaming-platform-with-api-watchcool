...
urlpatterns = [
    ...
    path("search/<str:query>/",cache_page(60*10)(views.SearchAPIView.as_view()),name="search"),
    path("series/show/<int:pk>/",cache_page(60*10)(views.SerieAPIView.as_view()),name="serie"),
    path("media/detail/<int:pk>/",cache_page(60*10)(views.MovieAPIView.as_view()),name="movie"),
